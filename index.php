...
<head>
  ...
  <?php include "operativo.php"; ?>
</head>

<body>
  <video src="img/muestra-de-casas-roberto-mendez-arquitecto.mp4" id="vidFondo"></video> 
  <!-- VIDEO TOMADO DE LA PAGINA DE YOUTUBE AUTORIA DEL ARQUITECTO Roberto Mendez -->
